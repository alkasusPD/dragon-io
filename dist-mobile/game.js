...
art.chapterBoss.src = 'assets/sprites/emerald-dreadwing-phase2-v4.png';
...
function draw(){
  ...
  enemies.forEach(e=>{const frame=Math.floor(e.anim)%12,size=e.chapterBoss?310:e.boss?240:e.champion?180:e.elite?150:108,flap=Math.sin(e.anim*Math.PI/6),bob=flap*(e.chapterBoss?1.5:1.2),aiming=lasers.some(l=>l.source===e),flightTilt=aiming?0:Math.sin(time*(e.chapterBoss?1.35:2)+e.phase)*(e.chapterBoss?.012:.018),rotation=e.rotation+flightTilt;drawMonsterVisual(e,frame,e.y+bob,size,rotation);drawPoisonCoating(e);drawEnemyHealthBar(e);});
